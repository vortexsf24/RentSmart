...
class DbConnection:
    ...
    async def delete_postings(self, paper_name: str) -> None:
        '''
    ...
    async def update_postings(self, paper_name: str, news: list) -> None:
        '''
        ...
        try:
            async with self.pool.acquire() as connection:
                async with connection.cursor() as cursor:
                    ...
                    for section in news:
                        insert_query = f'INSERT INTO {paper_name} (images, price) VALUES (%s, %s);'
    ...
    async def get_postings(self, paper_name: str) -> list:
        '''
